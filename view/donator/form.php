...
$cardUserID = 0;
if (isset($this->obj)) $cardUserID = $this->obj['userID'];
else if (isset($request->get->userID)) $cardUserID = $request->get->userID;

$this->setHasContainer(true);
?>
<main class="content">
<div class="funcBar d-flex text-white">
    <span class="funcTitle me-auto"><?=L('card.info');?> <?=(isset($this->obj))?L('Edit')." - ".$this->obj['cardUrl']:L('Add'); ?></span>
...
<form id="form-user" class="container my-3">
    ...
    <input type="hidden" name="userID" value="<?=$cardUserID; ?>">

<div class="card my-3">
    <div class="card-top">
      <div class="row my-3 mx-1">
        <div class="col-md-6">
          <h5 class="card-title"><?=(isset($this->obj))?L('Edit')." ".$this->obj['cardUrl']:L('Add'); ?> <?=L('Record');?></h5>
        </div>      
