...
$sqlAll = Database\Sql::select(['sttMailingLog', 'log']);


if(!empty($sttID)){
    $sqlAll->where(['log.sttID', '=', $sttID]);
}
            ...
            "column_function"=>"
                <div class='btn-group' role='group' aria-label=''>
                    ...
                    <ul class='dropdown-menu' aria-labelledby='btnGroupDrop".$data['logID']."'>
                        <li>
                            <div class='d-grid'>
                                <button class='btn btn-md btn-outline-dark btnView' type='button' data-id='".$data['logID']."' data-sttid='".$data['sttID']."'><i class='fas fa-sm fa-eye'></i> ".L('View')."</button>                                    
                                <button class='btn btn-md btn-outline-dark btnEdit' type='button' data-id='".$data['logID']."' data-sttid='".$data['sttID']."'><i class='fas fa-sm fa-edit'></i> ".L('Edit')."</button>
