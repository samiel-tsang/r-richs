...
// need change for support (radio, inline display, no checkbox, etc)
	public function checkbox(string $label, string $name, string $id, Array $options = [], string $prop="") {
?>
    <div class="form-group row mx-0">
        <label for="<?=$id;?>" class="col-md-4 p-0 px-md-3"><?=$label;?></label>
        <div class="col-md-8">
...
?>
	<div class="form-check">
            <input class="form-check-input" type="checkbox" id="<?=$id;?>_opt<?=$i;?>" name="<?=$name;?>" <?=$prop;?> value="<?=$value;?>"<?=(isset($this->obj) && isset($this->obj[$name]) && $this->obj[$name] == $value)?" checked":""; ?>>
